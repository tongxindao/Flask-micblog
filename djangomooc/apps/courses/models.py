...
class Course(models.Model):
    ...
    degree = models.CharField(choices=(("cj",u"初级"),("zj",u"中级"),("gj","高级")), max_length=2, verbose_name=u"课程难度")
    ...
    teacher_tell = models.CharField(default="", max_length=300, verbose_name=u"老师告诉你课程须知")
...
class BannerCourse(Course):
    class Meta:
        verbose_name = "轮播课程"
        verbose_name_plural = verbose_name
        # 设置 proxy 不会再生成新表，但会具备 model 的功能
        proxy = True
...
class CourseResource(models.Model):
    ...
    download = models.FileField(upload_to="course/resource/%Y/%s", verbose_name=u"资源文件", max_length=100)
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
