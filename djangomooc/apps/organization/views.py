...
class OrgView(View):
    ...
    def get(self, request):
        ...
        if search_keywords:
            # name__icontains 以 i 为首的表示不区分大小写且此句 icontains 可类比 sql 中的 SELECT语句
...
class TeacherDetailView(View):
    ...
    课程详情页
    """
    def get(self, request, teachers_id):
        teacher = Teacher.objects.get(id=int(teachers_id))
