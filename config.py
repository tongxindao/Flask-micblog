...
此处只针对qq邮箱。首先我们要开启SMTP服务，开启的过程中会得到一个授权码。这个授权码就是app.config['MAIL_PASSWORD'] = 'nwntuhwdkrrbbbbe'.而不是qq密码。切记。

总结：SSL协议搭配端口号465，TSL协议搭配端口号25。不论使用哪个协议，都要打开SMTP服务。
'''
...
MAIL_USE_TLS = False
MAIL_USE_SSL = True
MAIL_USERNAME = 'ohac@qq.com'
MAIL_PASSWORD = 'djfafdfejioneind'
